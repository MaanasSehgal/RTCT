        ...
        <div className="px-[8%] bg-black gap-8 grid grid-cols-12 grid-rows-2 mb-14">
            ...
            <Card className="bg-black col-span-12 sm:col-span-4 h-[300px] hover:shadow-lg transform hover:scale-105 transition duration-300">
                <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                    <p className="text-tiny text-[--darkText1] uppercase font-bold">Real-time Collaboration</p>
                    <h4 className="text-[--darkText2] font-medium text-large">Edit code & documents together</h4>
                </CardHeader>
            ...
            <Card className="bg-black col-span-12 sm:col-span-4 h-[300px] hover:shadow-lg transform hover:scale-105 transition duration-300">
                <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                    <p className="text-tiny text-[--darkText1] uppercase font-bold">Task Management</p>
                    <h4 className="text-[--darkText2] font-medium text-large">Organize & track project tasks</h4>
                </CardHeader>
                <Image
                    removeWrapper
            ...
            <Card className="bg-black col-span-12 sm:col-span-4 h-[300px] hover:shadow-lg transform hover:scale-105 transition duration-300">
                <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                    <p className="text-tiny text-[--darkText1] uppercase font-bold">Progress Tracking</p>
                    <h4 className="text-[--darkText2] font-medium text-large">Monitor your team's progress</h4>
                </CardHeader>
            ...
            <Card isFooterBlurred className="bg-black w-full h-[300px] col-span-12 sm:col-span-5 hover:shadow-lg transform hover:scale-105 transition duration-300">
                ...
                <CardFooter className="h-20 absolute bg-black/30 bottom-0 border-t-1 z-10 justify-between">
                    <div>
                        <p className="text-tiny text-[--darkText1] uppercase font-bold">Video Conferencing</p>
                        <h4 className="text-[--darkText2] font-medium text-large">Connect with your team instantly</h4>
                    </div>
                </CardFooter>
            </Card>
            ...
            <Card isFooterBlurred className="bg-black w-full h-[300px] col-span-12 sm:col-span-7 hover:shadow-lg transform hover:scale-105 transition duration-300">
                ...
                <CardFooter className="h-20 absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-100">
                    <div className="flex flex-grow gap-2 items-center">
                        <Image alt="Live editing icon" className="rounded-full w-10 h-11 bg-black" src="https://nextui.org/images/breathing-app-icon.jpeg" />
                        <div className="flex flex-col">
                            <p className="text-tiny text-[--darkText1] uppercase font-bold">Visual Studio Code</p>
                            <h4 className="text-[--darkText2] font-medium text-large">Experience seamless collaboration on the most loved code editor.</h4>
                        </div>
                    </div>
                </CardFooter>
            </Card>
...
// Edit documents and code simultaneously with live updates.

// Task Management and Progress Tracking
// Manage tasks and visualize project progress effortlessly.

// Video Conferencing and Voice Chat
// Communicate seamlessly with integrated video and voice chat.

// Version Control and Rollback
// Track and revert changes with powerful version control.

// VS Code
// Code with the world's most popular code editor.
